...
class UnitTest(unittest.TestCase):
    ...
    def test_problem038(self):
        self.assertEquals(problem38(), 932718654)

    def test_problem039(self):
        self.assertEquals(problem39(), 840)

    def test_problem040(self):
        self.assertEquals(problem40(), 210)

    def test_problem041(self):
        self.assertEquals(problem41(), 7652413)

    def test_problem042(self):
        self.assertEquals(problem42(), 162)
